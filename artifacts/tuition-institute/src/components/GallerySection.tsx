    ...
    <section id="gallery" className="py-24 bg-white">
      <div className="container mx-auto px-4 md:px-6">
          ...
          <AnimatePresence>
            {filteredImages.map((item) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#0D1B3E]/80 via-[#0D1B3E]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                  ...
                  <span className="text-[#60A5FA] text-xs font-bold uppercase tracking-wider mb-1 opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300 delay-100">
                    {item.category}
                  </span>
        ...
        <div className="mt-12 text-center">
          <button className="px-8 py-3 rounded-full border-2 border-[#1A56DB] text-[#1A56DB] font-bold hover:bg-[#1A56DB] hover:text-white transition-colors">
            Load More
          </button>
        </div>
      </div>
