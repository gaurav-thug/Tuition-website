...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0D1B3E] text-white pt-20 pb-8 border-t border-white/10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex flex-col inline-block">
              ...
              <span className="text-xs uppercase tracking-[0.2em] text-[#60A5FA]">
                Academy
              </span>
            </Link>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-[#1A56DB] hover:border-[#1A56DB] transition-all">
                <FaInstagram size={16} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-[#1A56DB] hover:border-[#1A56DB] transition-all">
                <FaFacebookF size={16} />
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#gallery" className="text-[#94A3B8] hover:text-white transition-colors text-sm font-medium">Life at BrightMinds</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-[#94A3B8] text-sm">
                <span className="text-[#60A5FA]">✉️</span>
                <a href="mailto:admissions@brightminds.edu.in" className="hover:text-white transition-colors">admissions@brightminds.edu.in</a>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[#94A3B8] text-sm">
            © {currentYear} BrightMinds Academy. All rights reserved.
          </p>
